...
--    arrived at destination point or crossed a waypoint) with parameters of invalid type

-- SDL must:
-- 1) Don't transfer the notification about changes to destination or waypoints to mobile application
---------------------------------------------------------------------------------------------------
  ...
  wayPoints = {
    {
      ...
      searchAddress =
      {
        ...
        countryCode = 123.50,
        postalCode = 123.50,
        administrativeArea = 123.50,
        subAdministrativeArea = 123.50,
        locality = 123.50,
        subLocality = 123.50,
        thoroughfare = 123.50,
        subThoroughfare = 123.50
      }
    }
  }
}
